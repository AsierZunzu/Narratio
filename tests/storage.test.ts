...
jest.mock('../src/database/db', () => {
  const { PodcastDatabase } = jest.requireActual('../src/database/db')
  return { db: new PodcastDatabase(':memory:') }
})
...
describe('Storage Cleanup', () => {
  ...
  test('should not delete files if no limits are set', () => {
    ...
    db.insertArticle('1', 'T1', 'L1', 'Mon, 01 Jan 2024 00:00:00 GMT', 'C1', null, file1)
  ...
  test('should delete oldest files by pub_date when MAX_AUDIO_FILES is exceeded', () => {
    ...
    db.insertArticle('2', 'T2', 'L2', 'Wed, 01 Jan 2025 00:00:00 GMT', 'C2', null, file2)

    fs.writeFileSync(file3, 'content3')
    db.insertArticle('3', 'T3', 'L3', 'Thu, 01 Jan 2026 00:00:00 GMT', 'C3', null, file3)
